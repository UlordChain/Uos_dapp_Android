...
import io.eblock.eos4j.blockchain.cypto.util.HexUtils;
import io.eblock.eos4j.blockchain.types.EosType;
import io.eblock.eos4j.blockchain.types.TypeAccountName;
import io.eblock.eos4j.blockchain.types.TypeActionName;
import io.eblock.eos4j.blockchain.types.TypePermissionLevel;
...
public class Action implements EosType.Packer {
    ...
    public Action(String account, String name, TypePermissionLevel authorization, String data,boolean isUos){
        this.account = new TypeAccountName(account,true);
        this.name = new TypeActionName(name);
        this.authorization = new ArrayList<>();
        if ( null != authorization ) {
            this.authorization.add(authorization);
    ...
    public Action(String account, String name,boolean isUos) {
        this (account, name, null, null,isUos);
    }
    ...
    public void setData(String data) {
        this.data = new JsonPrimitive(String.valueOf(data));
    }
