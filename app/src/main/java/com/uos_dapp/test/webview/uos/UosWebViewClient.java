...
public class UosWebViewClient extends WebViewClient {

    Context mContext;

    public UosWebViewClient(Context context) {
        mContext = context;
    }
    ...
    public void onPageFinished(WebView view, String url) {
        ...
        try {
            String scatterjs = IOUtils.toString(mContext.getAssets().open("test_uos1.js"), "UTF-8");
            view.loadUrl("javascript:" + scatterjs);
            return;
        } catch(IOException e) {
            e.printStackTrace();
        }
